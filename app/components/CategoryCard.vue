...
const isComingSoon = computed(() => props.componentsCount === undefined);
</script>
...
<template>
  <div class="space-y-3 text-center">
    <div
      v-if="isComingSoon"
      class="relative inline-flex overflow-hidden rounded-xl border sm:flex dark:border-zinc-700/80"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="absolute top-5 right-5 z-10 text-zinc-400 dark:text-zinc-500"
        width="27"
        height="13"
        fill="currentColor"
      >
    ...
    >
      <svg
        v-if="isNew"
        xmlns="http://www.w3.org/2000/svg"
        class="absolute top-5 left-5 z-10 text-zinc-950 dark:text-zinc-200"
        width="29"
        height="13"
        fill="currentColor"
      >
