...
<template>
  <div class="*:not-first:mt-2">
    <Card
      class="mx-auto w-full max-w-xl rounded-2xl border-0 bg-zinc-900 text-white shadow-xl"
    >
      <CardHeader class="flex items-center justify-between">
        <CardTitle class="text-lg font-semibold text-zinc-400">
          Balance
        </CardTitle>
        <div class="ml-auto">
          <Button
      ...
      <CardContent>
        <div class="mb-5 flex items-end gap-2">
          ...
          <span class="ms-2 text-base font-semibold text-green-400">
            +{{ balanceData.delta }}%
          </span>
        </div>
