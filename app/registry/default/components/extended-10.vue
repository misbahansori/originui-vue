...
import { LucideChartNoAxesColumn, LucideInfo } from "lucide-vue-next";
</script>
  ...
  <Card class="gap-4">
    <CardHeader class="gap-4 px-4">
      ...
      <CardDescription class="text-sm/relaxed">
        Preview of the financing options available to the user and the total amount of financing
        available.
      </CardDescription>
    </CardHeader>
    <CardContent class="grid grid-cols-2 gap-4 px-4">
      <div class="flex flex-col gap-1">
        ...
        <p class="text-xl font-semibold tracking-tight tabular-nums">$100,000</p>
      </div>
      <div class="flex flex-col gap-1">
        <div class="text-muted-foreground flex items-center gap-2">
