...
<template>
  <Dialog>
    ...
    <DialogContent
      class="flex max-h-[calc(100%-2rem)] flex-col gap-0 overflow-y-auto p-0 sm:max-h-[min(640px,80vh)] sm:max-w-lg [&>button:last-child]:top-3.5"
    >
                ...
                <div class="space-y-4">
                  ...
                  <div class="space-y-1">
                    ...
                    <p>
                      ...
                      owners shall not be liable for direct, indirect, incidental, consequential, or
                      punitive damages arising from user interactions with the platform.
                    </p>
                  </div>
                  ...
                  <div class="space-y-1">
                    ...
                    <p>
                      The website owners reserve the right to modify these terms at any time. Users
                      will be notified of any changes, and continued use of the website after
                  ...
                  <div class="space-y-1">
                    ...
                    <p>
                      The website owners reserve the right to terminate or suspend access to the
                      service immediately, without prior notice, for any breach of these Terms of
                      Service.
                    </p>
                  </div>
                  ...
                  <div class="space-y-1">
                    ...
                    <p>
                      ...
                      the jurisdiction in which the website operates, without regard to its conflict
                      of law provisions.
                    </p>
                  </div>
                  ...
                  <div class="space-y-1">
                    ...
                    <p>
                      ...
                      the provided channels on our website.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <DialogFooter class="bg-background border-t px-6 py-4 sm:items-center">
        <span v-if="!hasReadToBottom" class="text-muted-foreground grow text-xs max-sm:text-center">
