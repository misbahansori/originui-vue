            ...
            <div class="px-6 py-4">
              <div class="[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold">
                ...
                <div class="space-y-1">
                  ...
                  <p>
                    Users can manage their subscription preferences through the account dashboard.
                    Options include upgrading or downgrading plans, updating payment methods, and
                    viewing billing history. Changes take effect at the start of the next billing
                    cycle.
                  </p>
                </div>
              </div>
